...
var UI = {
	...
	createItem : function(msg, fromUserId, direction,isSend) {   //消息Item
		...
		/*if(1==ConversationManager.isGroup&&0==direction){
			...
			switch (msg.type){
				...
				case 3:// 语音 
					...
					if("groupchat"==msg.chatType && myData.isShowGroupMsgReadNum){
						contentHtml = "<p id='voiceP_"+msg.id+"' class='chat_content' onclick='UI.showAudio(\"" + msg.content + "\",\"" + msg.id + "\",\""+(myFn.isNil(msg.isReadDel)?0:msg.isReadDel)+"\");GroupManager.sendRead(\"" + msg.id + "\")'>"
						...
						contentHtml = "<p id='voiceP_"+msg.id+"' class='chat_content' onclick='UI.showAudio(\"" + msg.content + "\",\"" + msg.id + "\",\""+(myFn.isNil(msg.isReadDel)?0:msg.isReadDel)+"\")'>"
								+     "<img id='voiceImg' src='img/voice.png' style='width:25px; height:25px;margin-top:-2.5px'> <span style='display:inline; margin-left:15px; margin-right:10px;'>"+msg.timeLen+"\" </span>"
								+	  "<div id='voice_"+msg.id+"'></div>"
								+ "</p>"
								+msgStatusHtml;
				...
				case 6:// 视频
					...
					if("groupchat"==msg.chatType && myData.isShowGroupMsgReadNum){
						// contentHtml = "<div  id='vidoePlay_"+msg.id+"' class='div_Video  chat_content' >"
						...
						// contentHtml = "<div  id='vidoePlay_"+msg.id+"' class='div_Video  chat_content ' style='width:240px;height:240px;' >"
