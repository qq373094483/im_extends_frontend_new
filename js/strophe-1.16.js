...
Strophe.Connection.prototype = {
    ...
    */
    ...
    _dataRecv: function (req, raw) {
        //console.log("_dataRecv  req "+req.data);
        // console.log("_dataRecv  raw "+Strophe.serialize(raw));
...
Strophe.Bosh.prototype = {
     ...
     */
    _buildBody: function (ns) {
        var ns=!ns?Strophe.NS.HTTPBIND:ns;
    ...
    onRequestStateChange: function (func, req) {
        Strophe.debug("request id "+req.id+"."+req.sends+
                      " state changed to "+req.xhr.readyState);
        if (req.abort) {
            req.abort = false;
