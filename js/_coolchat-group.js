$(function() {
	...
	$("#btnDelete").click(function() {
		if (GroupManager.roomData.userId = myData.userId) {
			...
			window.wxc.xcConfirm("是否确认解散本群组？", window.wxc.xcConfirm.typeEnum.confirm,{
...
var GroupManager = {
	...
	createMyItem : function(obj,content,timeSend,timeSendStr) {
		...
		var rightTop="<div id='righttop_"+obj.jid+"' style=\"height:0px;float:right;position:relative;top:0px;right:0px;display:none\"><img src=\"img/right_top.png\" style=\"width:10px;height:10px;\"></div>";
